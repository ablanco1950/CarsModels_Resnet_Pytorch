...
train_data = datasets.ImageFolder( 'KaggleCarsByModels_1_196/train', transform=train_transforms)
test_data = datasets.ImageFolder( 'KaggleCarsByModels_1_196/valid', transform=test_transforms)
